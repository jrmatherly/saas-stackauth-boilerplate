    ...
    <div className="container relative pt-24 pb-20 text-center">
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col space-y-4 overflow-hidden">
          ...
          >
            {['The', 'Ultimate', 'SaaS', 'Techstack'].map((text, index) => (
              <motion.span
                key={`hero-text-${text}`}
          ...
          >
            Your product is ready to go. Start selling it today. This is the
            best way to get your product out there and start generating revenue.
          </motion.p>
        </div>
        <motion.div
