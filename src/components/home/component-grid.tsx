  ...
  return (
    <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
      ...
      <Popover
        ...
        setOpenPopoverAction={setOpenPopover}
      >
        <button
          type="button"
      ...
      <Tooltip content="Spoons of Salt is an opinionated collection of components, hooks, and utilities for your Next.js project.">
