  ...
  all: [
    {
      id: '1',
      isRead: false,
      avatar: '/example-avatars/morty.jpg',
      description: 'requested to join ITS.',
      name: 'Morty Smith',
      time: '2 hours ago',
      type: 'request',
    },
    {
      id: '2',
      isRead: false,
      avatar: '/example-avatars/rick.jpg',
    ...
    },
    {
      id: '3',
      isRead: false,
      avatar: '/example-avatars/deadpool.jpg',
      description: 'ate chimichangas.',
      name: 'Deadpool',
      time: 'Yesterday',
    },
    {
...
export default function Component(props: CardProps) {
  ...
  return (
    <Card
      className="w-full max-w-[420px] border border-border bg-card text-card-foreground"
      {...props}
    >
      <CardHeader className="flex flex-col px-0 pb-0 bg-background">
        <div className="flex w-full items-center justify-between px-5 py-2">
          <div className="inline-flex items-center gap-1">
            <h4 className="inline-block align-middle text-large font-medium text-foreground">
              Notifications
            </h4>
            <Chip
              size="sm"
        ...
        <Tabs
          ...
          classNames={{
            base: 'w-full',
            tabList:
              'gap-6 px-6 py-0 w-full relative rounded-none border-b border-border',
            cursor: 'w-full',
            tab: 'max-w-fit px-2 h-12 text-foreground',
          }}
          color="primary"
      ...
      <CardBody className="w-full gap-0 p-0 bg-card">
      ...
      <CardFooter className="justify-between border-t border-border px-5 py-3 bg-background">
        {/* <Button
